                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group" id="treatment-form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select class="form-control" id="search-select-treatments"
                                                                name="treatment-id">
